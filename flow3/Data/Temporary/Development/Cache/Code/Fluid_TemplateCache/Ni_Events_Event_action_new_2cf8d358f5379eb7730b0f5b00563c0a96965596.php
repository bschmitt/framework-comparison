<?php
class FluidCache_Ni_Events_Event_action_new_2cf8d358f5379eb7730b0f5b00563c0a96965596 extends \TYPO3\Fluid\Core\Compiler\AbstractCompiledTemplate {
...
$arguments27['typeOnly'] = false;
$renderChildrenClosure28 = function() use ($renderingContext, $self) {
return \TYPO3\Fluid\Core\Parser\SyntaxTree\ObjectAccessorNode::getPropertyPath($renderingContext->getTemplateVariableContainer(), '_all', $renderingContext);
};
$viewHelper29 = $self->getViewHelper('$viewHelper29', $renderingContext, 'TYPO3\Fluid\ViewHelpers\DebugViewHelper');
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\FormViewHelper
$arguments35 = array();
$arguments35['action'] = 'create';
$arguments35['objectName'] = 'newEvent';
...
// Rendering ViewHelper TYPO3\Fluid\ViewHelpers\Form\TextfieldViewHelper
$arguments41 = array();
$arguments41['property'] = 'description';
...
$viewHelper55 = $self->getViewHelper('$viewHelper55', $renderingContext, 'TYPO3\Fluid\ViewHelpers\Form\SubmitViewHelper');
...
$output37 .= $viewHelper55->initializeArgumentsAndRender();
...
$viewHelper56 = $self->getViewHelper('$viewHelper56', $renderingContext, 'TYPO3\Fluid\ViewHelpers\FormViewHelper');
$viewHelper56->setArguments($arguments35);
$viewHelper56->setRenderingContext($renderingContext);
$viewHelper56->setRenderChildrenClosure($renderChildrenClosure36);
// End of ViewHelper TYPO3\Fluid\ViewHelpers\FormViewHelper

$output34 .= $viewHelper56->initializeArgumentsAndRender();
